...
export default class Matrix4f {
  ...
  public multiply(matrix: Matrix4f): void {
  ...
  public static perspective(fov: number, aspect: number, near: number, far: number): Matrix4f {
  ...
  public static normalize(v: Vertex3f) {
  ...
  public static subtractVectors(a: Vertex3f, b: Vertex3f) {
    let f = a.x() - b.x()
    let f1 = a.y() - b.y()
    let f2 = a.z() - b.z()
  ...
  public static cross(a: Vertex3f, b: Vertex3f) {
  ...
  public lookAt(camera: Vertex3f, target: Vertex3f, up: Vertex3f) {
